...
function doStep(currentPosition, pathSoFar, hasUsedDoubleSmall) {
    
    if(currentPosition == 'start' && pathSoFar.includes('start')) {
        // can't visit start more than once
        return;
    }
    ...
    options.forEach(option => {
        doStep(option, [...pathSoFar], hasUsedDoubleSmall);
    });
}
